function [sys,x0,str,ts,simStateCompliance] = sldemo_tanksfun_puc(t,x,u,flag,inflow,outflow, ...
                                           lolim,hilim,area)
...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%%%
    otherwise
    error(message('simdemos:sldemo_tanksfun_puc:UnhandledFlag', flag));
...
figs = sldemo_tankgui_puc('figures');
